...
Boot up all `50` computers and attach them to your network. __What is the `Y` value of the first packet sent to address `255`?__

Your puzzle answer was __23057__.
...
Monitor packets released to the computer at address `0` by the NAT. __What is the first `Y` value delivered by the NAT to the computer at address `0` twice in a row?__

Your puzzle answer was __15156__.
